...
module.exports = {
    ...
    if(args.length === 0){
      ...
      let {canonicalTitle, synopsis, startDate, endDate, chapterCount, volumeCount, averageRating, ratingRank, status, subtype} = manga.attributes;
      ...
      if(chapterCount, volumeCount, averageRating, ratingRank === null){
        ...
        .addField('Published 🖋️', `between **${startDate}** and ${endDate}`, true)
